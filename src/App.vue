...
export default {
  ...
  computed: {
    getBackgroundColor() {
      ...
      switch (true) {
        default:
          return 'background-color: cornflowerblue; background: linear-gradient(360deg, #55707e 0%, rgba(255, 255, 255, 0) 100%), #042232;';
        case averageTemperature >= 30:
          return 'background-color: #ff4500; background: linear-gradient(360deg, #55707e 0%, rgba(255, 255, 255, 0) 100%), #042232;';
        case averageTemperature >= 20 && averageTemperature < 30:
          return 'background-color: #ffd700; background: linear-gradient(360deg, #55707e 0%, rgba(255, 255, 255, 0) 100%), #042232;';
        case averageTemperature >= 10 && averageTemperature < 20:
          return 'background-color: #b6eb4b; background: linear-gradient(360deg, #55707e 0%, rgba(255, 255, 255, 0) 100%), #042232;';
        case averageTemperature >= 0 && averageTemperature < 10:
          return 'background-color: #836fff; background: linear-gradient(360deg, #55707e 0%, rgba(255, 255, 255, 0) 100%), #042232;';
        case averageTemperature < 0:
          return 'background-color: #63b8ff; background: linear-gradient(360deg, #55707e 0%, rgba(255, 255, 255, 0) 100%), #042232;';
      }
    },
    isLoading() {
