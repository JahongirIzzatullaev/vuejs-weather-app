  ...
  <section class="forecast" v-else-if="getForecasts.length !== 0">
    ...
    <ul class="forecast__list">
      <li class="forecast__item"
          v-for="(forecast,index) of getForecasts.data.slice(0,1)"
          :key="index">
        <div class="forecast__group forecast-item">
          <span class="forecast__scale temp">{{ Math.ceil(forecast.temp) }} &#176;C</span>
        </div>
        ...
        <div class="forecast-group">
          ...
          <div class="forecast__group forecast-item">
            <span class="forecast__number">Pressure: </span>
            <br>
            <span class="forecast__scale">{{ Math.ceil(forecast.pres) }} mb</span>
          </div>
          <div class="forecast__group forecast-item">
            <span class="forecast__number">Wind speed:</span>
            <br>
            <span class="forecast__scale"> {{ Math.ceil(forecast.wind_spd) }} m/s</span>
          </div>
          <div class="forecast__group forecast-item">
            <span class="forecast__number">Humidity: </span>
            <br>
            <span class="forecast__scale">{{ Math.ceil(forecast.rh) }} %</span>
          </div>
          <div class="forecast__group forecast-item">
            <span class="forecast__number">Wind direction: </span>
            <br>
            <span class="forecast__scale">{{ Math.ceil(forecast.wind_dir) | toTextualDescription }}</span>
          </div>
        </div>
      </li>
    </ul>
